...
@ModelEntity
@XMLElement
@ImplementationClass(DeprecatedFMLExcelModelSlot.FMLExcelModelSlotImpl.class)
...
public interface DeprecatedFMLExcelModelSlot
	...
	abstract class FMLExcelModelSlotImpl
			...
			implements DeprecatedFMLExcelModelSlot {
