...
public class TestExcelCellRange extends AbstractTestExcel {
	...
	public void testExcelCellRangeConverter() {
		...
		assertEquals("http://www.openflexo.org/excel-test/TestResourceCenter/Excel/Workbook1.xlsx$Feuil1/range[A2:E7]", converter.convertToString(cellRange));

		ExcelCellRange cellRange2 = converter
				.convertFromString("http://www.openflexo.org/excel-test/TestResourceCenter/Excel/Workbook1.xlsx$Feuil1/range[A2:E7]", null);
